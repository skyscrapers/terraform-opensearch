output "arn" {
  ...
  value = element(
    concat(
      ...
      aws_elasticsearch_domain.public_es.*.arn,
    ),
    0,
  )
}
...
output "domain_id" {
  ...
  value = element(
    concat(
      ...
      aws_elasticsearch_domain.public_es.*.domain_id,
    ),
    0,
  )
}
...
output "domain_name" {
  ...
  value = element(
    concat(
      ...
      aws_elasticsearch_domain.public_es.*.domain_name,
    ),
    0,
  )
}
...
output "endpoint" {
  ...
  value = element(
    concat(
      ...
      aws_elasticsearch_domain.public_es.*.endpoint,
    ),
    0,
  )
}
